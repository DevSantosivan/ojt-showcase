      ...
      <FadeInSection delay={0.1}>
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            The On-the-Job Training (OJT) program serves as a vital bridge
            between academic learning and professional practice. It provides
            students with hands-on experience, allowing them to apply
            theoretical knowledge in a real-world work environment. Through this
            program, students gain industry exposure, develop professional
            skills, and build valuable networks that will contribute to their
            career growth.
          </p>
        </section>
      </FadeInSection>
      ...
      <FadeInSection delay={0.15}>
        <section className="space-y-4">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
            ...
            <li>
              Develop technical and interpersonal skills relevant to the IT
              industry
            </li>
            <li>
              Gain practical experience in system development, documentation,
            ...
            {[
              {
                icon: Building2,
                label: "Agency",
                value: "L&S Cable TV, Inc.",
              },
              {
                icon: MapPin,
                label: "Address",
                value: "83XF+Q2F, Langka Rd, San Jose, Occidental Mindoro",
              },
              {
                icon: Clock,
                label: "Office Hours",
                value: "8:00 AM – 12:00 PM and 1:00 PM – 5:00 PM",
              },
              { icon: Timer, label: "Duration", value: "486 Hours" },
              {
                icon: Calendar,
                label: "Date Started",
                value: "February 03, 2026",
              },
              { icon: Calendar, label: "Date Ended", value: "April 06, 2026" },
